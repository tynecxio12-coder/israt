...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Israt Jahan — Frontend Developer & UI/UX Designer" },
      { name: "description", content: "Portfolio of Israt Jahan — a frontend developer crafting premium, animated, responsive web experiences with React, Node.js and modern UI design." },
      { name: "author", content: "Israt Jahan" },
      { property: "og:title", content: "Israt Jahan — Frontend Developer & UI/UX Designer" },
      { property: "og:description", content: "Portfolio of Israt Jahan — a frontend developer crafting premium, animated, responsive web experiences with React, Node.js and modern UI design." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Israt Jahan — Frontend Developer & UI/UX Designer" },
      { name: "twitter:description", content: "Portfolio of Israt Jahan — a frontend developer crafting premium, animated, responsive web experiences with React, Node.js and modern UI design." },
